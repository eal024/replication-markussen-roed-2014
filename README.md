...
│   ├── 2026-05-08_iv_jackknife_minimal.R  # Minimalt jackknife-eksempel (uten tidsdimensjon)
│   ├── 2026-05-08_iv_jackknife_med_tid.R  # Jackknife med tidsdimensjon (ligning 2 → 5 trinn for trinn)
